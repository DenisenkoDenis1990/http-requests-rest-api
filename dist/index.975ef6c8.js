...
function onClick(e) {
    ...
    (0, _fetchCountriesJsDefault.default)(e.target.value.trim()).then((countries)=>renderCountriesList(countries));
}
function renderCountriesList(countries) {
    ...
    } else if (countries.length === 1) refs.countryInfoEl.insertAdjacentHTML("beforeend", `<h1 class="country-name"><img class="country-item__image" src = "${countries[0].flags.png}" alt = "${countries[0].name.official}">${countries[0].name.official}</h1>
...
},{"./css/styles.css":"1CY4s","lodash.debounce":"3JP5n","./fetchCountries.js":"fTQqv","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","notiflix":"5WWYd"}],"1CY4s":[function() {},{}],"3JP5n":[function(require,module,exports) {
var global = arguments[3];
/**
...
`).then((response)=>{
        if (!response.ok) (0, _notiflixDefault.default).Notify.failure("Oops, there is no country with that name");
        return response.json();
    });
}
exports.default = fetchCountries;

},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","notiflix":"5WWYd"}],"gkKU3":[function(require,module,exports) {
